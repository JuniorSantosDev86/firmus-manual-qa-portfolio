...
Manual QA portfolio project documenting test planning, test cases, bug reports, test executions and QA evidence for the Firmus application.
...
The main goal of this portfolio is to demonstrate practical QA skills through structured documentation, test planning, manual test case design, bug reporting, evidence collection and test execution reporting.
...
| Area | Description |
|---|---|
| Test Planning | Definition of scope, risks, objectives and deliverables |
